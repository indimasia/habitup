...
export function HabitItem({ habit, isCompleted, onToggle }: HabitItemProps) {
  ...
  return (
    <div
      className={cn(
        'transition-all duration-200 ease-in-out flex items-start sm:items-center gap-3 sm:gap-4 p-3 rounded-lg',
    ...
    >
      <Checkbox
        ...
        className="h-6 w-6 rounded-full data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground border-2 mt-1 sm:mt-0"
      />
